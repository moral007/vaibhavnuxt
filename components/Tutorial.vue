...
<template>
  ...
  >
    ...
    >
      <section class="grid grid-cols-3 gap-4 md:gap-8 max-w-5xl w-full z-20">
        <svg
          viewBox="0 0 221 65"
          fill="none"
        ...
        >
          ...
          <defs data-v-3bc1edbc="">
            <clipPath id="a" data-v-3bc1edbc="">
              <path fill="#fff" d="M0 0h221v65H0z" data-v-3bc1edbc=""></path>
            </clipPath>
          </defs>
        </svg>
        <div
          class="col-span-3 rounded p-6 flex flex-col border-2 border-[#747474] bg-[#1414144d] rounded-md p-6"
          data-v-3bc1edbc=""
        >
          <div
            ...
            data-v-3bc1edbc=""
          >
            <h4 class="font-medium text-2xl" data-v-3bc1edbc="">Get Started</h4>
            <svg
              width="40"
              height="40"
              viewBox="0 0 40 40"
          ...
          <p class="mb-2" data-v-3bc1edbc="">
            Remove this welcome page by removing
            <a
              class="bg-[#BFBFBF] text-[#0C6DFD] dark:bg-white/10 rounded font-mono p-1 font-bold"
              data-v-3bc1edbc=""
              >&lt;NuxtWelcome /&gt;</a
            >
            tag or creating an
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          class="gradient-border underline text-[#0C6DFD] border-2 border-[#747474] bg-[#1414144d] rounded-md p-6 cursor-pointer col-span-3 sm:col-span-1 p-4 flex flex-col"
          data-v-3bc1edbc=""
          ><svg
            width="40"
            height="40"
          ...
          <h5 class="font-semibold underline text-xl mt-4" data-v-3bc1edbc="">
            Documentation
          </h5>
          <p class="mt-2" data-v-3bc1edbc="">
            We highly recommend you take a look at the Nuxt documentation,
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          class="cursor-pointer underline border-2 border-[#747474] bg-[#1414144d] text-[#0C6DFD] rounded-md p-6 gradient-border col-span-3 sm:col-span-1 p-4 flex flex-col"
          data-v-3bc1edbc=""
          ><svg
            width="40"
            height="40"
          ...
          <p class="mt-2" data-v-3bc1edbc="">
            Nuxt is open source and the code is available on GitHub, feel free
            to star it, participate in discussions or dive into the source.
          </p></a
        >
        <a
          ...
          target="_blank"
          rel="noopener"
          class="cursor-pointer underline border-2 border-[#747474] bg-[#1414144d] text-[#0C6DFD] rounded-md p-6 gradient-border col-span-3 sm:col-span-1 p-4 flex flex-col gap-y-4"
          data-v-3bc1edbc=""
          ><svg
            width="40"
            height="40"
          ...
          <h5 class="font-semibold underline text-xl" data-v-3bc1edbc="">
            Twitter
          </h5>
          <p data-v-3bc1edbc="">
            Follow the Nuxt Twitter account to get latest news about releases,
            new modules, tutorials and tips.
          </p></a
        >
      </section>
    </section>
